...
class settings:
	...
	files = {'Chen_2018':'inferred_params_0_400.json',
	'Qiao_2021_ILs':'inferred_params_0_400.json',
	'Qiao_2021_Mg':'inferred_params_0_200.json',
	'Valles_2020':'inferred_params_0_200.json',
	'Ber_2016':'inferred_params_0_120.json'}
...
if __name__ == '__main__':
	...
	for study,file in settings.files.items():
		with open(os.path.join(settings.results_folder,study,file)) as ff:
			params = json.load(ff)
		normalized_params = {}
